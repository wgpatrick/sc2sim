 ...
 */
export const BUILDS: NamedBuild[] = [
  {
    name: "Gateway macro opener",
    description:
      "Standard economic opening: pump probes with early chrono, expand into a Cyber Core and first Stalkers.",
    order: [
      "Probe",
      "chrono:Probe",
      "Probe",
  ...
  },
  {
    ...
    description:
      "Rush a Cybernetics Core and chrono out early Adepts for cheese/harass timing.",
    order: [
      "Probe",
      "chrono:Probe",
      "Probe",
  ...
  },
  {
    ...
    description:
      "Minimal tech rush — how fast can a Cybernetics Core finish from the 8-worker start?",
    order: ["Probe", "Pylon", "Gateway", "Assimilator", "CyberneticsCore"],
  },
  {
    name: "Proxy-pylon warp-in Zealots",
    description:
      "Warp Gate tech + a proxy Pylon: keep Gateways safe at home, then WARP Zealots onto the enemy (arrival ≈ warp-in time, not a cross-map walk). Watch the last column.",
    order: [
