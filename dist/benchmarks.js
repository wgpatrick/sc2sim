...
function describeRange(label, r) {
...
export function benchmarkCaption(race, arrivalSeconds) {
    const b = BENCHMARKS[race];
    const nearestIsExpansion = Math.abs(arrivalSeconds - b.naturalExpansion.avgSeconds) <= Math.abs(arrivalSeconds - b.firstArmyUnit.avgSeconds);
